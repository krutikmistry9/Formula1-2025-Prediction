...
# Load FastF1 2024 Japanese GP race session
...
qualifying_2025 = pd.DataFrame({
    "Driver": ["Lando Norris", "Charles Leclerc", "Oscar Piastri", "Lewis Hamilton", "Max Verstappen", 
               ...
               "Gabriel Bortoleto", "Oliver Bearman", "Pierre Gasly", "Lance Stroll", "Jack Doohan"],
    "QualifyingTime (s)": [86.995, 87.299, 87.027, 87.610, 86.983,
                           87.569, 87.897, 88.696, 87.906, 87.615,
                           87.836, 88.000, 88.570, 87.318, 87.555,
                           88.622, 87.867, 87.822, 89.271, 88.877]
})
...
print("\n🏁 Predicted 2025 Japanese GP Winner with Available Data 🏁\n")
print(final_results)
