...
qualifying_2025 = pd.DataFrame({
    ...
    "QualifyingTime (s)": [71.625, 71.682, 71.120, 71.526, 71.059,
                           71.867, 71.586, 72.634, 72.525, 71.907,
                           72.398, 72.102, 72.183, 70.899, 71.391,
                           72.385, 72.340, 72.199, 72.667, 72.142]
})
...
print("\n🏁 Predicted 2025 Canadian GP Winner with Available Data 🏁\n")
print(final_results)
