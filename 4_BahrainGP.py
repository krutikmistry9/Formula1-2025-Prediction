...
# Load FastF1 2024 Bahrain GP race session
...
qualifying_2025 = pd.DataFrame({
    ...
    "QualifyingTime (s)": [90.267, 90.175, 89.841, 90.772, 90.423,
                           91.271, 91.885, 91.594, 92.165, 92.040,
                           90.680, 91.303, 92.067, 90.009, 90.213,
                           92.186, 92.373, 90.216, 92.283, 91.245]
})
...
print("\n🏁 Predicted 2025 Bahrain GP Winner with Available Data 🏁\n")
print(final_results)
