...
qualifying_2025 = pd.DataFrame({
    ...
    "QualifyingTime (s)": [87.481, 87.670, 87.304, 88.201, 87.294,
                           88.418, 88.303, 89.092, 88.191, 88.109,
                           88.164, 88.204, 88.728, 87.407, 87.866,
                           89.462, 88.648, 88.367, 88.645, 88.739]
})
...
print("\n🏁 Predicted 2025 Saudi Arabian GP Winner with Available Data 🏁\n")
print(final_results)
