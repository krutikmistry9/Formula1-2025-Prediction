...
qualifying_2025 = pd.DataFrame({
    ...
    "QualifyingTime (s)": [86.269, 86.754, 86.375, 87.006, 86.204,
                           86.987, 87.604, 86.824, 87.363, 86.682,
                           86.569, 86.943, 87.473, 86.385, 86.271,
                           87.151, 87.999, 87.710, 87.830, 87.186]
})
...
print("\n🏁 Predicted 2025 Miami GP Winner with Available Data 🏁\n")
print(final_results)
