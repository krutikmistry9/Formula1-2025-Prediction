...
qualifying_2025 = pd.DataFrame({
    ...
    "QualifyingTime (s)": [74.962, 75.604, 74.670, 75.765, 74.704,
                           75.746, 75.431, 76.613, 76.379, 75.473,
                           75.432, 00.000, 76.518, 74.807, 75.772,
                           76.260, 76.918, 75.787, 75.581, 76.256]
})
...
print("\n🏁 Predicted 2025 Emilia Romagna GP Winner with Available Data 🏁\n")
print(final_results)
