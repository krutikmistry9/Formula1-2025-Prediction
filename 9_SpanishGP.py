...
qualifying_2025 = pd.DataFrame({
    ...
    "QualifyingTime (s)": [71.755, 72.131, 71.546, 72.045, 71.848,
                           72.252, 72.284, 73.201, 72.763, 72.641,
                           73.201, 73.385, 73.190, 71.848, 72.111,
                           72.756, 73.315, 72.199, 73.058, 73.334]
})
...
print("\n🏁 Predicted 2025 Spanish GP Winner with Available Data 🏁\n")
print(final_results)
